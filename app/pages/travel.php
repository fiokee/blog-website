							...
							<article class="card article-card article-card-sm h-100">
								<a href="article.html">
									<div class="card-image">
										...
										<img loading="lazy" decoding="async" src="../pages/images/post/post-1.jpg" alt="Post Thumbnail" class="w-100" width="420" height="280">
									</div>
								</a>
							...
							<article class="card article-card article-card-sm h-100">
								<a href="article.html">
									<div class="card-image">
										...
										<img loading="lazy" decoding="async" src="../pages/images/post/post-2.jpg" alt="Post Thumbnail" class="w-100" width="420" height="280">
									</div>
								</a>
								<div class="card-body px-0 pb-0">
									<ul class="post-meta mb-2">
							...
							<article class="card article-card article-card-sm h-100">
								<a href="article.html">
									<div class="card-image">
										...
										<img loading="lazy" decoding="async" src="../pages/images/post/post-6.jpg" alt="Post Thumbnail" class="w-100" width="420" height="280">
									</div>
								</a>
								<div class="card-body px-0 pb-0">
									<ul class="post-meta mb-2">
							...
							<article class="card article-card article-card-sm h-100">
								<a href="article.html">
									<div class="card-image">
										...
										<img loading="lazy" decoding="async" src="../pages/images/post/post-8.jpg" alt="Post Thumbnail" class="w-100" width="420" height="280">
									</div>
								</a>
								<div class="card-body px-0 pb-0">
									<ul class="post-meta mb-2">
									...
									<h2><a class="post-title" href="article">Portugal and France Now Allow Unvaccinated Tourists</a></h2>
									<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna …</p>
