...
<html lang="en">
    <head>
        ...
        <link href="../pages/admin/css/styles.css" rel="stylesheet" />
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="inputpassword" class="form-control" id="inputpassword" type="password" placeholder="Create a password" />
                                                        <label for="inputpassword">Password</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input name="confirmpassword" class="form-control" id="confirmpassword" type="password" placeholder="Confirm password" />
